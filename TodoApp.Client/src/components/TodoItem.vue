<template>
    <tr>
        ...
        <td class="py-1.5 border-b-1"><button @click="editTodo" class="bg-yellow-500  text-black rounded-sm p-0.5 cursor-pointer hover:bg-amber-300  transition-colors"><EditIcon /></button></td>
